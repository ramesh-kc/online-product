...
<div class="row">
	...
	<div class="col-md-9">
		<div>
			<ol class="breadcrumb">
				<li><a href="<c:url value="/adminWelcome"></c:url>">Home</a></li>
		...
		<div class="row">
			...
			<div class="col-md-6 text-center col-sm-8 col-xs-4">
			...
			<div class="col-md-6 text-center col-sm-6 col-xs-6">
				<div class="caption">
					...
					<p>
						<a href="<c:url value="/editProduct/${product.productId}"></c:url>"
							class="btn btn-primary" role="button">Edit Product</a>
					
						<a href="<c:url value="/deleteProduct/${product.productId}"></c:url>"
							class="btn btn-danger" role="button">Delete Product</a>
					</p>
				</div>
			</div>
			<!-- /.col -->
